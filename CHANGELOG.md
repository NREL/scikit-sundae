...
## [v1.0.4](https://github.com/NREL/scikit-sundae/tree/v1.0.4)

### Bug Fixes
- Fix conditional checks for constraints to allow numpy arrays ([#36](https://github.com/NREL/scikit-sundae/pull/36))
