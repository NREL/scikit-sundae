...
.. py:class:: CVODE(rhsfn, **options)
   ...
   :param method: Specifies the linear multistep method. The suggested settings are
                  to use 'Adams' nonstiff problems and 'BDF' for stiff problems. The
                  default is 'BDF'.
   ...
   :param lband: Lower Jacobian bandwidths. Given an ODE system ``yp = F(t, y)``,
   ...
   :param max_order: Specifies the maximum order for the linear multistep method. BDF
                     ...
                     The default is the method's, i.e., 5 for BDF and 12 for Adams.
   ...
   .. py:method:: init_step(t0, y0)
      ...
      :returns: :class:`~sundae.cvode.CVODEResult` -- Custom output class for CVODE solutions. Includes pretty-printing
